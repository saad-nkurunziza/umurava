...
-- CreateEnum
CREATE TYPE "ChallengeStatus" AS ENUM ('Open', 'Closed', 'Postponed', 'Canceled');

-- CreateEnum
CREATE TYPE "UserChallengeStatus" AS ENUM ('Open', 'Ongoing', 'Completed');
...
CREATE TABLE "user_challenges" (
    ...
    "status" "UserChallengeStatus" NOT NULL DEFAULT 'Ongoing',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
